...
class Classifier(L.LightningModule):
    def __init__(self):
        ...
        self.conv_layers = nn.Sequential(
            # Block 1: 3x3 conv, 32 filters
            nn.Conv2d(3, 32, kernel_size=3, padding=1),
            nn.ReLU(),
            nn.MaxPool2d(2),
            
            # Block 2: 3x3 conv, 64 filters
            nn.Conv2d(32, 64, kernel_size=3, padding=1),
            nn.ReLU(),
            nn.MaxPool2d(2),
            
            # Block 3: 3x3 conv, 128 filters
            nn.Conv2d(64, 128, kernel_size=3, padding=1),
            nn.ReLU(),
            nn.MaxPool2d(2),
            
            # Block 4: 3x3 conv, 256 filters
        ...
        self.flatten_size = 256 * 8 * 8  # 128x128 -> 8x8 after 4 maxpool layers
